...
public enum DescriptionEnum
{
	...
	DescriptionEnum(int n, int imf, int tf, int il, int tmod, int tmon, int ibg)
	{
	...
	public final String getDescriptionImageBackground(Context context)
	{
		return context.getString(imageBackgroundId);
	}
}
